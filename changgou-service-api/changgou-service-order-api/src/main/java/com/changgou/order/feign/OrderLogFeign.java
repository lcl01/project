...
//    Result<PageInfo> findPage(@RequestBody(required = false) OrderLog orderLog, @PathVariable (value = "id") int page, @PathVariable (value = "id") int size);
//
//    /***
//     * OrderLog分页搜索实现
//     * @param page:当前页
...
//    Result<PageInfo> findPage(@PathVariable (value = "id") int page, @PathVariable (value = "id") int size);
     ...
     */
    @PutMapping(value="/{id}")
    Result update(@RequestBody OrderLog orderLog, @PathVariable (value = "id") String id);
     ...
     */
    @GetMapping("/{id}")
    Result<OrderLog> findById(@PathVariable (value = "id") String id);
